...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 13867 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 7392 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 3258 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 22792 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 29614 };
      job.tasks = [task];
      const employee: IEmployee = { id: 13109 };
      job.employee = employee;
