...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 22739 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 22336 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 9844 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 4100 }];
    ...
    it('Should call employee query and add missing value', () => {
      ...
      const employeeCollection: IEmployee[] = [{ id: 14433 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 11972 };
      jobHistory.job = job;
      const department: IDepartment = { id: 7279 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 10119 };
      jobHistory.employee = employee;
